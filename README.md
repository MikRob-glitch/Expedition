...
- **Tirage souvenir** — chaque équipe choisit sa photo préférée en fin de chasse — photo d'équipe comprise — (zoom sur chaque photo avant de trancher) ; le maître du jeu récupère les tirages **encadrés** au **format 10×15 prêt à imprimer** (portrait ou paysage), à l'unité ou en ZIP, **depuis l'application comme depuis la console**. Le cadre porte la rose des vents en **sceau à cheval sur la photo**, puis, centrés sous elle, le nom de l'équipe, celui de la chasse, le lieu et la date — et le **logo du lieu** à droite si vous en joignez un. Une équipe partie sans choisir ? Un bouton retient sa photo la mieux notée, modifiable ensuite ligne par ligne.
