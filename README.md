...
- **Repérage terrain** — un mode mobile de la console pour préparer une chasse **sur place**, indice par indice : la photo indice, et surtout la **position réelle relevée au GPS** avec sa précision affichée. Un QR fait passer le repérage du poste fixe au téléphone. C'est ce qui transforme un parcours écrit au bureau (coordonnées à ±100 m, invalidables) en parcours vendable.
